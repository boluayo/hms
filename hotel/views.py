...
@login_required(login_url='signin')
def remove_item2(request): #This is the function to remove an item from the cart page.
...
def placeorder(request):
    if request.method == 'POST':
        ...
        cburl = 'http://18.191.106.41/paidorder' #This ip '54.86.10.239' address is from the one i got from AWS.
